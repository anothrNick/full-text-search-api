...
# ENV CGO_ENABLED=0
ENV SRC_DIR=${HOME}/go/src/github.com/anothrNick/full-text-search-api/
...
ENTRYPOINT ["/go/src/github.com/anothrNick/full-text-search-api/api"]
...
COPY --from=builder /go/src/github.com/anothrNick/full-text-search-api/api /bin/api
